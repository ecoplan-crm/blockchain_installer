...
public final class AssetTransfer implements ContractInterface {
    ...
    public void InitLedger(final Context ctx) {
        ...
        CreateAsset(ctx, "asset1", "blue", 5, "Tomoko", 30000);
        CreateAsset(ctx, "asset2", "red", 5, "Brad", 40000);
        CreateAsset(ctx, "asset3", "green", 10, "Jin Soo", 50000);
        CreateAsset(ctx, "asset4", "yellow", 10, "Max", 60000);
        CreateAsset(ctx, "asset5", "black", 15, "Adrian", 70000);
        CreateAsset(ctx, "asset6", "white", 15, "Michel", 70000);
     ...
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public String UpdateSizeAsset(final Context ctx, final String assetID, final String newSize) {
        ChaincodeStub stub = ctx.getStub();
        String assetJSON = stub.getStringState(assetID);
        ...
        Asset newAsset = new Asset(asset.getAssetID(), asset.getColor(), Integer.parseInt(newSize), asset.getOwner(), asset.getAppraisedValue());
        //Use a Genson to conver the Asset into string, sort it alphabetically and serialize it into a json string
        String sortedJson = genson.serialize(newAsset);
        stub.putStringState(assetID, sortedJson);
