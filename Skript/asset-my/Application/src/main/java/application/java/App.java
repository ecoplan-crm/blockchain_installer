...
public class App {
	...
	public static Gateway connect() throws Exception{
		...
		// load a CCP
		Path networkConfigPath = Paths.get("..", "..", "test-network-Kopie", "organizations", "peerOrganizations", "org1.example.com", "connection-org1.yaml");
		//Path networkConfigPath = Paths.get("..", "..", "my-network", "organizations", "peerOrganizations", "org1.example.com", "connection-org1.yaml");
